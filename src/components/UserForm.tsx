...
import {validateEmail, validateName, validatePassword} from "./Form/formValidation";
            ...
            {({errors, touched, isValidating}) => (
                <Form className="form">
                    ...
                    <FormFieldWithValidation errors={errors} name="email" type="email" validate={validateEmail}
                                             touched={touched}/>
                    <FormFieldWithValidation errors={errors} name="password" type="password" validate={validatePassword}
                                             touched={touched}/>
                    <SubmitButton/>
                </Form>
            )}
